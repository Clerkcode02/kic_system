...
class MilestoneApprovedNotification extends Notification implements ChannelResolvable, ShouldQueue
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'amount' => $this->milestone->amount->toDecimal(),
            'currency' => $this->milestone->currency,
            'message' => "Milestone \"{$this->milestone->title}\" was approved. Escrow release is in progress.",
        ];
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage())
            ...
            ->line("Your milestone \"{$this->milestone->title}\" was approved. Funds will be released from escrow shortly.")
