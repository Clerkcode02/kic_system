...
class QuotationRejectedNotification extends Notification implements ChannelResolvable, ShouldQueue
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => 'Your quotation was rejected.',
        ];
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage())
            ->subject('Your quotation was rejected')
            ->line('The customer rejected your quotation.')
    ...
    public function toWebPush(object $notifiable): array
    {
        return [
            ...
            'body' => 'The customer rejected your quotation.',
            'url' => $this->url(),
        ];
    }
